...
\multirow{4}{*}{SBIR}    & Cosine                  & 9.0                   & 5.1                & 9.0                      & 5.1                   & 4.6               & 2.0            \\
                         & 3D shape \cite{wang2015sketch}               & 6.1                   & 1.0                & 7.0                    & 1.8                 & 3.6               & 0.5            \\
                         & SaN \cite{yu2017sketch}                    & 15.3                  & 5.8                & 18.9                   & 8.5                 & 10.1              & 4.2            \\
                         & Siamese \cite{qi2016sketch}                & 24.4                  & 14.6               & 25.6                   & 15.3                & 8.3              & 3.7            \\ \hline
\multirow{5}{*}{ZSL}     & ESZSL \cite{romera2015embarrassingly}                  & 16.0                  & 8.3               & 17.2                   & 9.5                & 4.8               & 1.7            \\
                         ...
                         & SSE \cite{zhang2015zero}                    & 6.9                   & 2.3                & 7.3                    & 3.3                 & 4.1               & 1.2            \\
...
\multirow{6}{*}{ZS-SBIR} & CVAE \cite{yelamarthi2018zero}                   & 33.4                  & 22.6               & 31.2                   & 19.9                & 10.2              & 4.9            \\
                         & SEM-PCYC \cite{dutta2019semantically}                   & 28.0                  & 17.7               & 30.0                   & 19.4                & 12.4              & 5.7            \\
...
\footnotetext{The detailed category split will be found in Appendix}
...
\footnotetext{The results of ZSIH \cite{shen2018zero} become much worse after using this strategy, and thus we omit its results in Table~\ref{tab:1}.}
